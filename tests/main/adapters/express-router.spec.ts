...
describe('ExpressRouter', () => {
  ...
  beforeAll(() => {
    req = getMockReq({ body: { any_body: 'any_body' }, params: { any_params: 'any_params' } })
    res = getMockRes().res
  ...
  it('should call handle with correct request', async () => {
    ...
    expect(controller.handle).toHaveBeenCalledWith({ any_body: 'any_body', any_params: 'any_params' })
